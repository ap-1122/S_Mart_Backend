  ...
  //  @Autowired
    ...
    public Order placeOrder(String email, Long addressId, String paymentMethod) {
        ...
        for (CartItem cartItem : cart.getItems()) {
            ...
            orderItem.setOrderedPrice(variant.getPrice());
        ...
        // ==========================================
        // 🚀 NEW: PRIME DISCOUNT LOGIC (10% OFF)
        // ==========================================
        if (user.hasActiveSubscription()) {
            double discount = totalAmount * 0.10; // 10% Calculate karo
            totalAmount = totalAmount - discount; // Total me se minus karo
            System.out.println("🌟 PRIME USER DETECTED! Applied Discount: ₹" + discount);
        }

        // Final Amount Set karo
...
//----------------------------------------
//update in upper code and add membership subscription model
